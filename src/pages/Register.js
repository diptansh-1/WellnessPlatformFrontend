              ...
              {formData.password && (
                <div className="mt-2 space-y-1">
                  <div className="flex items-center text-xs">
                    <CheckCircle className={`w-3 h-3 mr-1 ${passwordRequirements.length ? 'text-green-500' : 'text-gray-400'}`} />
                    <span className={passwordRequirements.length ? 'text-green-600' : 'text-gray-500'}>
                      At least 6 characters
                    </span>
                  </div>
                  <div className="flex items-center text-xs">
                    <CheckCircle className={`w-3 h-3 mr-1 ${passwordRequirements.uppercase ? 'text-green-500' : 'text-gray-400'}`} />
                    <span className={passwordRequirements.uppercase ? 'text-green-600' : 'text-gray-500'}>
                      One uppercase letter
                    </span>
                  </div>
                  <div className="flex items-center text-xs">
                    <CheckCircle className={`w-3 h-3 mr-1 ${passwordRequirements.lowercase ? 'text-green-500' : 'text-gray-400'}`} />
                    <span className={passwordRequirements.lowercase ? 'text-green-600' : 'text-gray-500'}>
                      One lowercase letter
                    </span>
                  </div>
                  <div className="flex items-center text-xs">
                    <CheckCircle className={`w-3 h-3 mr-1 ${passwordRequirements.number ? 'text-green-500' : 'text-gray-400'}`} />
